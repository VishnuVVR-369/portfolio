...
export function GuardianBadge({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className="inline-flex h-[18px] w-[22px] items-center justify-center rounded-[3px] border border-[var(--color-accent-dim)] bg-[var(--color-canvas-deep)] text-[9px] font-semibold tracking-wider text-[var(--color-accent)]"
      >
        LC
      </span>
