...
The hard part is not making an answer appear; it is making the answer defensible. Rather than merely returning a chunk ID, the citation flow matches a claim to precise source text and page location, then highlights that span in the PDF. Citation quality is measured, not assumed: a citation-validation pipeline verifies generated quotes against the source text, currently at 82% citation accuracy on a 50-question evaluation set.
